...
<body>
    <?php
		...
		$relatedProduct = getRelatedProductsById($product['id_category']);
		if (isset($_POST['btn-adtocart'])) {
			$user = $_SESSION['user'];
			$quantity = $_POST['quantity_product'];
			if (existProductUserInCart($user['id_user'], $id_product)) {
				$_SESSION['message'] = 'Product already in cart';
			} else {
				try {
					addToCart($id_product,$user['id_user'], $quantity);
                ...
                <div class="row details_row">
                    ...
                    <div class="col-lg-6">
                        <div class="details_image">
                            <div class="details_image_large"><img
                                    src="<?php echo (!empty($product['image_product'])) ? '../images/products/'.$product['image_product'] : '../images/products/noimage.jpg'; ?>"
                                    alt="">
                    ...
                    <div class="col-lg-6">
                        <div class="details_content">
                            <div class="details_name"><?php echo $product['name_product'] ?></div>
                            <div class="details_discount">
                                <?php echo empty($product['sale_product']) ?  null : '$'.$product['price_product'];  ?>
                            </div>
                            <div class="details_price">
                                <?php  echo !empty($product['sale_product']) ? '$'.$product['sale_product'] : '$'.$product['price_product']; ?>
                            </div>
                            ...
                            <div class="details_text">
                                <p><?php echo $product['description_product'] ?></p>
                            </div>
                            ...
                            <div class="product_quantity_container">
                                <form action="product.php" method="POST">
                                    <div class="product_quantity clearfix">
                                        <span>Qty</span>
                                        <input id="quantity_input" name="quantity_product" type="text" pattern="[1-9]*"
                                            value="1">
                                    ...
                                    <button name="btn-adtocart" type="submit"
                                        class="btn cart_button btn-adtocart"><span>Add to cart</span></button>
                                    <style>
                                    .btn-adtocart {
                                        width: 178px;
                                        height: 61px;
