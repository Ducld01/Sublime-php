    ...
    $product = getProductById($id);
        if (isset($_POST['btn-update'])) {
            ...
            $filename = $_FILES['image']['name'];
                ...
                try {
                    updateProduct($id_product, $name, $price, $sales, $filename, $createAt, $description, $special, $viewnumber, $category);
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="form-sample" method="post" action="editProduct.php"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="name"
                                                            value="<?=$product['name_product']?>" class="form-control"
                                                            placeholder=" Name" required />
                                                            <input type="hidden" name="id_product"
                                                            value="<?=$product['id_product']?>" class="form-control"
                                                             required />
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="price"
                                                            value="<?=$product['price_product']?>" class="form-control"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="sales"
                                                            value="<?=$product['sale_product']?>" class="form-control"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" name="createAt"
                                                            value="<?=$product['createAt_product']?>" class="form-control"
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input"
                                                                    name="special" id="membershipRadios1" value="0"
                                                                    <?=$product['special_product'] ? '' : 'checked' ?>> Special </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-5">
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input"
                                                                    name="special" id="membershipRadios2" value="1" <?=$product['special_product'] ? 'checked' : '' ?>>
                                                                Normal </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                    <input type="text" readonly name="viewnumber"
                                                            value="<?=$product['view_of_number']?>"
                                                            class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" name="description" 
                                                            id="exampleTextarea1" rows="4"><?=$product['description_product']?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <div class="input-group col-xs-12">
                                                            <input type="text" class="form-control file-upload-info" value="<?=$product['image_product']?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group d-flex justify-content-between">
                                                    ...
                                                    <button type="submit" name="btn-update"
                                                        class="btn btn-gradient-primary me-2 btn-update">Update</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
