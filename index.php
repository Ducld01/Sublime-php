...
<body>
 ...
 ?>
            ...
            <div class="home_slider_container">
                ...
                <div class="owl-carousel owl-theme home_slider">
                    ...
                    <div class="owl-item home_slider_item">
                        <div class="home_slider_background" style="background-image:url(./client/images/home_slider_1.jpg)">
                        </div>
        ...
        <div class="avds">
            <div class="avds_container d-flex flex-lg-row flex-column align-items-start justify-content-between">
                <div class="avds_small">
                    <div class="avds_background" style="background-image:url(./client/images/avds_small.jpg)"></div>
                ...
                <div class="avds_large">
                    <div class="avds_background" style="background-image:url(./client/images/avds_large.jpg)"></div>
	...
	?>
            ...
            <div class="container">
                <div class="row icon_box_row">
                    ...
                    <div class="col-lg-4 icon_box_col">
                        <div class="icon_box">
                            <div class="icon_box_image"><img src="./client/images/icon_1.svg" alt=""></div>
                    ...
                    <div class="col-lg-4 icon_box_col">
                        <div class="icon_box">
                            <div class="icon_box_image"><img src="./client/images/icon_2.svg" alt=""></div>
                    ...
                    <div class="col-lg-4 icon_box_col">
                        <div class="icon_box">
                            <div class="icon_box_image"><img src="./client/images/icon_3.svg" alt=""></div>
        ...
        <footer class="footer">
            <div class="footer_background" style="background-image:url(./client/images/footer.jpg)"></div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div
    ...
    <script src="./client/plugins/Isotope/isotope.pkgd.min.js"></script>
